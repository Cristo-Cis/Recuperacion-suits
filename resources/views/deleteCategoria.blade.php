...
<div class="sm:max-w-lg w-full p-10 bg-white rounded-xl z-10">
    <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-400">Estas seguro de eliminar este proveedor?</p>
    </div>
    <form action="{{ route('crud.destroyCategoria', $categoria->id)}}" method="POST">
        @csrf
        @method("DELETE")
        <div class="mb-6">
            <label for=""
            ...
            <input type="text" id="categoria" name="categoria"
                ...
                value="{{$categoria->categoria}}" readonly>
        </div>
